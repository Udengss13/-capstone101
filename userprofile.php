            ...
            <div class="row mt-4">
                ...
                <div class="col-7 mt-2 ">
                    <a href="user-edit-profile.php?updateid=<?php echo $fetch_user['id'];?>">
                        <span class="btn btn-outline-primary mx-2">Edit Profile <i class="fa-solid fa-pen-to-square"></i></span>
                    </a>



                    <a href="#imagesec">
                        <span class="btn btn-outline-primary mx-2"> My Pet <i class="fa-solid fa-paw"></i></span>
                    </a>
                    <a href="appointment-user.php">
                        <span class="btn btn-outline-primary mx-2"> Appointment <i
